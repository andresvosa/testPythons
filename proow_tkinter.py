...
def myClick():
    ...
    myLabel3.grid() # Kui määrata kindel koht siis siin pannakse need 
...
myButton1 = Button(root, text='Enter text', padx=50, pady=20, command=myClick, fg='red', bg='blue') #, state= DISABLED
